...
== Modified for the mantidproject to work with Visual Studio 2010 ==
Changes:
   - Added line 645 "ld_args.append ('/MANIFEST')" to embed manifests as 2010 doesn't use external ones


Contains MSVCCompiler, an implementation of the abstract CCompiler class
for the Microsoft Visual Studio 2010.
